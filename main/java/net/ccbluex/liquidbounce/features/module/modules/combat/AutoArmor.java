...
import net.ccbluex.liquidbounce.features.module.modules.world.SlientChestStealer;
...
public class AutoArmor extends Module {
    ...
    public void onRender3D(final Render3DEvent event) {
        ...
        SlientChestStealer slientChestStealer = LiquidBounce.moduleManager.getSlientChestStealer();
        if (slientChestStealer.getState() && !slientChestStealer.getListStack().isEmpty()) return;
