...
public class Fly extends Module {
    ...
    public void onPacket(PacketEvent event) {
        ...
        if(packet instanceof C03PacketPlayer) {
            ...
            if(modeValue.get().equalsIgnoreCase("AAC5.2.0-Smooth")){
                event.cancelEvent();
        ...
        if(packet instanceof S08PacketPlayerPosLook) {
            ...
            if(mode.equalsIgnoreCase("AAC5.2.0-Smooth")){
                aac5FlyStart=true;
    ...
    private void sendAAC5Packets(){
        ...
        for(C03PacketPlayer packet : aac5C03List){
            if(packet.isMoving()){
                ...
                mc.getNetHandler().addToSendQueue(new C03PacketPlayer.C06PacketPlayerPosLook(packet.x,1e+159,packet.z, yaw, pitch, true));
                mc.getNetHandler().addToSendQueue(new C03PacketPlayer.C06PacketPlayerPosLook(packet.x,packet.y,packet.z, yaw, pitch, true));
            }
        }
        noPacketModify = false;
        aac5C03List.clear();
