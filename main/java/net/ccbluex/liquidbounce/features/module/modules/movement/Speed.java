...
import net.ccbluex.liquidbounce.features.module.modules.movement.speeds.seksin.SeksinSpeed;
import net.ccbluex.liquidbounce.features.module.modules.movement.speeds.seksin.SeksinTeleport;
import net.ccbluex.liquidbounce.features.module.modules.movement.speeds.seksin.SeksinTimer;
...
public class Speed extends Module {
    ...
    public final FloatValue SeksinTimerValue = new FloatValue("SeksinTimer", 0.5F, 0.1F, 1F);
    public final IntegerValue SeksinDelayValue = new IntegerValue("SeksinDelay", 100, 0, 2000);
    public final FloatValue Seksin2Timer = new FloatValue("Seksin2Timer", 0.5F, 0.1F, 1F);
    public final FloatValue Seksin2Speed = new FloatValue("Seksin2Speed", 0.5F, 0.1F, 1F);
    public final IntegerValue SeksinTeleportTick = new IntegerValue("SeksinTeleportTick", 5, 1, 10);
