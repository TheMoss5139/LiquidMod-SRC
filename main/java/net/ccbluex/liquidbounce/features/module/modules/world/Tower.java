...
public class Tower extends Module {
    ...
    private final ListValue modeValue = new ListValue("Mode", new String[] {
            "Jump", "Motion", "ConstantMotion", "MotionTP", "Packet", "Teleport", "AAC3.3.9", "AAC3.6.4", "AAC4Jump"
    }, "Motion");
    ...
    public void onRender2D(final Render2DEvent event) {
        if(counterDisplayValue.get()) {
            ...
            final BlockOverlay blockOverlay = LiquidBounce.moduleManager.getBlockOverlay();
