...
class Tracers : Module() {
    ...
    open fun drawTraces(x : Double, y : Double, z : Double, color: Color) {
        val x = x * mc.timer.renderPartialTicks
                - mc.renderManager.renderPosX
        val y = y * mc.timer.renderPartialTicks
                - mc.renderManager.renderPosY
        val z = z * mc.timer.renderPartialTicks
                - mc.renderManager.renderPosZ
