...
public class LiquidWalk extends Module {
    ...
    public final ListValue modeValue = new ListValue("Mode", new String[] {"Vanilla", "NCP", "AAC", "AAC3.3.11", "AACFly", "Spartan", "Dolphin", "SeksinKit"}, "NCP");
        ...
        switch(modeValue.get().toLowerCase()) {
            ...
            case "seksinkit":
                if(mc.thePlayer.isInWater()) {
                    mc.thePlayer.motionY = 0;
                    mc.thePlayer.onGround = true;
                    mc.thePlayer.motionX *= 1.16;
                    mc.thePlayer.motionZ *= 1.16;
                }
                break;
            case "aac3.3.11":
                if(mc.thePlayer.isInWater()) {
