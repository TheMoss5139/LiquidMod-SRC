...
//        if (assets.containsKey("logo"))
            builder.setLargeImage("rickroll", "MC ${LiquidBounce.MINECRAFT_VERSION} - ${LiquidBounce.CLIENT_NAME} b${LiquidBounce.CLIENT_VERSION}")
        if (mc.thePlayer != null) {
            builder.setSmallImage("liquidmod", mc.thePlayer.name)
        }
        ...
        if (mc.thePlayer != null) {
            ...
            // Set display infos
            builder.setDetails("LiquidMod " + "Server: ${if (mc.isIntegratedServerRunning || serverData == null) "Singleplayer" else serverData.serverIP}")
