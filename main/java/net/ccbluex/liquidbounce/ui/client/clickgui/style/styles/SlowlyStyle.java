    ...
    public void drawModuleElement(int mouseX, int mouseY, ModuleElement moduleElement) {
        ...
        if (!moduleValues.isEmpty()) {
            ...
            if (moduleElement.isShowSettings()) {
                ...
                moduleElement.slowlySettingsYPos = moduleElement.getY() + 6 + addedY;
                int startX = moduleElement.getX() + moduleElement.getWidth() + 4;
                int startY = moduleElement.slowlySettingsYPos;
                ...
                if (!isChanged) {
                    if (mouseX >= startX && mouseX <= moduleElement.getX() + moduleElement.getWidth() + moduleElement.getSettingsWidth() && mouseY >= startY && mouseY <= moduleElement.slowlySettingsYPos) {
